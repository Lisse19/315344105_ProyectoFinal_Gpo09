...
glm::vec3 spotlightDir(10.0, 0.0f, 0.0f);


bool active;

// -------------------------- POSICIÓN LUZ DE ESFERAS ---------------------------------

glm::vec3 pointLightPositions[] = {
	glm::vec3(-5.0f, 1.0f, 5.0f),
	glm::vec3(5.0,   1.0f, 5.0f),
	glm::vec3(-5.0f, 1.0f, -5.0f),
	glm::vec3(5.0f,  1.0f, -5.0f)
};
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.diffuse"), 4.0f, 4.0f, 4.0f);
